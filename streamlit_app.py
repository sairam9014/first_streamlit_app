...
# funtion to repeat a code block
def get_fruityvice_data(this_fruit_choice):
  # importing ruquests to connect fruityvice API with streamlit
...
# adding streamlit stop function
# streamlit.stop()
...
if streamlit.button('Add a new fruit to list'):
  my_cnx = snowflake.connector.connect(**streamlit.secrets["snowflake"])
